...
// const CertificationsComponent = () => {  // ✅ Renamed from Services to CertificationsComponent
//   return (
//     <section className="py-20 bg-gray-100 dark:bg-gray-900">
//       <div className="container mx-auto px-4">
//         <motion.h2 
...
//         {/* Swiper Component */}
//         <Swiper effect="cards" grabCursor={true} modules={[EffectCards]} className="mySwiper w-full max-w-lg">
//           {Certifications.map((certification, index) => (  // ✅ Renamed services.map to Certifications.map
//             <SwiperSlide key={index} className="rounded-lg overflow-hidden shadow-lg bg-white dark:bg-gray-800 p-6">
//               <a href={certification.link} target="_blank" rel="noopener noreferrer">
//                 <img
...
// import { EffectCards, Autoplay, Pagination, Navigation } from "swiper/modules"; // ✅ Ensured Autoplay is imported
